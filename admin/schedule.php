                        ...
                        <table class="table table-bordered">
                            ...
                            <?php
                                            ...
                                            $result = $mysqli->query('SELECT
                                                                             ...
                                                                             employee_schedule.eid as eid,
                                                                             employee_schedule.start_time as start_time,
                                                                             employee_schedule.end_time as end_time,
                                                                             employee_schedule.available as available
                                                                         FROM employees 
                                                                       INNER JOIN employee_schedule
                                                                        ON employees.id = employee_schedule.eid');
                                            if($result === FALSE){
                                                die(mysql_error());
                                            }
                            ...
                            <tr>
                                ...
                                <td class="text-center"> <?php if($obj->available == 1){ echo "Yes";}else{ echo "No";} ?></td>
