...
if (isset($_POST['edit_transaction'])) {
        $id = $_GET['id'];
        $emp_id = $_GET['emp_id'];
        $date_served = date("Y/m/d");
        $query = "UPDATE orders SET served=1, date_served='$date_served' WHERE id='$id' AND emp_id_makeup = '$emp_id' OR emp_id_hair='$emp_id'";
                        ...
                        <div class="panel panel-default">
                            ...
                            <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="employee" value="<?php echo $_GET['emp_fname'].' '.$_GET['emp_lname'];?>" disabled>   
                                     </div>
                                     <div class="col-md-6">
                                    <label>Served</label>
                                    <input type="text" class="form-control" name="served" value="Yes" disabled>   
                                     </div>
                                </div>
                                <br>
                                <?php
